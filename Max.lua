...
local Window = OrionLib:MakeWindow({Name = "Misc-X Hub", HidePremium = true, IntroText = "Misc-XHub Library", SaveConfig = true, ConfigFolder = "Misc-X Hub"})
})
local Tabs = {
...
--Create Tabs
    ...
    local ToggleMobAura = Tabs.Main:AddToggle("ToggleMobAura", {Title = "Farm Nearest", Default = false })
...
--Mastery
    ...
    local ToggleMasteryFruit = Tabs.Main:AddToggle("ToggleMasteryFruit", {Title = "Farm BF Mastery", Default = false })
    ToggleMasteryFruit:OnChanged(function(Value)
        AutoFarmMasDevilFruit = Value
    end)
    Options.ToggleMasteryFruit:SetValue(false)

    local ToggleMasteryGun = Tabs.Main:AddToggle("ToggleMasteryGun", {Title = "Farm Gun Mastery", Default = false })
...
spawn(function()
    ...
    local ToggleVatChatKiDi = Tabs.Main:AddToggle("ToggleVatChatKiDi", {Title = "Farm Ectoplasm [ Soon ]", Default = false })
...
Tabs.Notification:AddParagraph({
	...
	Content = "Ngày ra mắt 27/07/2024"
